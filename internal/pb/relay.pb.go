...
const (
	...
	Relaytype_Probe        Relaytype = 5
	Relaytype_Success      Relaytype = 6
)
...
func (x *ProbeSignal) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ProbeSignal) ProtoMessage() {}

func (x *ProbeSignal) ProtoReflect() protoreflect.Message {
	mi := &file_relay_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ProbeSignal.ProtoReflect.Descriptor instead.
func (*ProbeSignal) Descriptor() ([]byte, []int) {
	return file_relay_proto_rawDescGZIP(), []int{4}
}

func (x *ProbeSignal) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *ProbeSignal) GetData() []byte {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *Disconnect) GetErrCode() int32 {
	if x != nil {
		return x.ErrCode
	}
	return 0
...
func (x *CircuitSuccess) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CircuitSuccess) ProtoMessage() {}

func (x *CircuitSuccess) ProtoReflect() protoreflect.Message {
	mi := &file_relay_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CircuitSuccess.ProtoReflect.Descriptor instead.
func (*CircuitSuccess) Descriptor() ([]byte, []int) {
	return file_relay_proto_rawDescGZIP(), []int{6}
}

func (x *CircuitSuccess) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
var file_relay_proto_rawDesc = []byte{
	...
	0x22, 0x3f, 0x0a, 0x0b, 0x70, 0x72, 0x6f, 0x62, 0x65, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x6c, 0x12,
	...
	0x61, 0x22, 0x44, 0x0a, 0x0a, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x12,
	0x1c, 0x0a, 0x09, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01,
	...
	,
}
...
var file_relay_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_relay_proto_goTypes = []interface{}{
	...
	(*ProbeSignal)(nil),     // 5: pb.probeSignal
	(*Disconnect)(nil),      // 6: pb.disconnect
	(*CircuitSuccess)(nil),  // 7: pb.circuitSuccess
}
